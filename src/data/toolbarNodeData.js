const toolbarNodeData = [
    { type: '服务器', icon: require('../assets/topo/root.png'), width: 140, height: 80, num: 1, classType: 'T1' },
    { type: '防火墙', icon: require('../assets/topo/router.png'), width: 50, height: 50, num: 1, classType: 'T2' },
    { type: 'Tomcat', icon: require('../assets/topo/container.png'), width: 140, height: 80, num: 1, classType: 'T1' },
    { type: '网关', icon: require('../assets/topo/container.png'), width: 140, height: 80, num: 1, classType: 'T1' },
    { type: '数据库', icon: require('../assets/topo/router.png'), width: 115, height: 60, num: 1, classType: 'T1' },
    { type: '台位', icon: require('../assets/topo/compute.png'), width: 150, height: 100, num: 1, classType: 'T1' },
