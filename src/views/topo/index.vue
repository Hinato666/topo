    ...
    class Topo {
      ...
      initDefineSymbol() {
        ...
        defs
          ...
          .attr(
            "d",
            "M709.3 285.8C668.3 202.7 583 145.4 484 145.4c-132.6 0-241 102.8-250.4 233-97.5 27.8-168.5 113-168.5 213.8 0 118.9 98.8 216.6 223.4 223.4h418.9c138.7 0 251.3-118.8 251.3-265.3 0-141.2-110.3-256.2-249.4-264.5z"
          );
        ...
        earth
          ...
          .attr(
            "d",
            "m 845.31717,511.09495 c 1.42222,-104.72727 -9.82626,-192.25859 -25.6,-262.46465 -96.8404,40.98586 -187.60404,58.69899 -269.05858,61.93132 v 255.09495 c 100.07272,-2.97374 199.2404,-21.59192 294.65858,-54.56162 z"
          );
        ...
        earth
          ...
          .attr(
            "d",
            "m 550.14141,585.95556 v 213.59191 c 95.41819,0 186.69899,-20.42828 272.80809,-61.02626 13.05858,-74.47272 19.52323,-142.86869 21.46262,-205.70505 -95.0303,32.71111 -194.19798,50.42424 -294.27071,53.1394 z"
          );
        ...
        docker
          ...
          .attr(
            "d",
            "m 203.09333,633.25867 a 28.16,28.16 0 1 0 28.928,28.24533 28.501333,28.501333 0 0 0 -8.704,-20.13867 27.946667,27.946667 0 0 0 -20.224,-8.10666 z"
          )
      ...
      // 绘制配置完成标识
      drawNodeCode() {
        this.nodeCodes = this.nodes
          .filter((item) => item.isConfig == "true")
          .append("g")
          .attr("class", "node-code")
          .attr(
            "transform",
            "translate(" + -symbolSize / 2 + "," + symbolSize / 3 + ")"
          );
      ...
      drawNodeSymbol() {
        ...
        foreground.attr("d", (data) =>
          arc.endAngle(Math.PI * 2 * (data.active / data.total))
        );
        front.attr("d", (data) =>
          arc.endAngle(Math.PI * 2 * (data.active / data.total))()
        );
